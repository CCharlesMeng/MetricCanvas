...
for (const version of versions) {
  ...
  for (const path of ['packages/metric-canvas/tests/browser', 'packages/embed/tests/browser', 'packages/embed/examples', 'packages/embed/tests/serve.mjs', 'packages/page/fixtures/contract-valid/url-navigation-page.json', 'packages/page/fixtures/contract-valid/dimension-params-page.json', 'packages/page/fixtures/parameter-extraction/tokens-parameter-source.json', 'pages']) {
