...
for (const version of versions) {
  ...
  for (const path of ['packages/metric-canvas/tests/browser', 'packages/embed/tests/browser', 'packages/embed/examples', 'packages/embed/tests/serve.mjs', 'packages/embed/tests/dqe-fixture-endpoint.mjs', 'tools/dqe-sim/fixtures/ioc-opportunity-list.json', 'tools/dqe-sim/fixtures/ioc-dimension-values.json', 'packages/page/fixtures/contract-valid/url-navigation-page.json', 'packages/page/fixtures/contract-valid/dimension-params-page.json', 'pages']) {
