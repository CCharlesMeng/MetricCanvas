...
用户指出顶部指标过碎、缺少示例卡片层次，以及“结构分析”命名与表达重复。本文技术通过结果仍成立，但不能作为业务组织和视觉质量已达标的证明；旧模型提示预设了概览/趋势/结构分析，不能据此证明自主章节设计。最新修订方案见 [refinement/design.md](../../plan/scenario-guided-refinement/design.md)，本轮仅规划，尚未修复。
