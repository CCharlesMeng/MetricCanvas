...
状态：计划用例，未执行。对应 [tasks.md](tasks.md) 与 [Spec](2026-09-17-page-template-inputs-spec.md)。
...
执行证据在实施时追加 verification.md，标明本地替身或真实提供方；本表不提前勾选。完整 Tokens 示例贯穿 AT01、AT05、AT06、AT07、AT09 与 AT11。
