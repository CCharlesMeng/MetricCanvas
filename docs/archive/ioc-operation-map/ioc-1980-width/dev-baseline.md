...
| 还原契约 | `docs/archive/ioc-operation-map/ioc-1980-width/restore-contract.json` |
...
| 需求路径 | `docs/archive/ioc-operation-map/ioc-1980-width/tasks.md`、`alpha-tests.md`、`story-delta-frontend-design.md` |
