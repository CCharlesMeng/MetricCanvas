...
2026-09-14 用户确认纳入 #126。详细范围见[参考手册方案](../unified-authoring/2026-09-14-page-metadata-reference.md)。C0 负责真源、字段生成、Bundle/Skill 分发与漂移门禁，各模块负责人补充语义和示例；沿现有任务实施，不另建重复功能票。
