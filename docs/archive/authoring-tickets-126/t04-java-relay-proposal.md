...
按 #105/#106 完整票及截至本次读取的评论核对；#130 原生 blocked_by 为空。事实真源：`docs/archive/wayfinder-95/wayfinder-105-provider-api-2026-09-10.txt`；盘古对账 `docs/archive/wayfinder-95/wayfinder-105-106-fact-check-2026-09-09.md`。旧 Swagger/旧 Java 仅供历史对比，后出正文取代旧要求。
