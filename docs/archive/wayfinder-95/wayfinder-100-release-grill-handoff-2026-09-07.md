...
总体背景见 `docs/archive/wayfinder-95/wayfinder-95-handoff-2026-09-07.md`，但它是历史快照，先刷新 GitHub 状态。
...
- #109 已交付 main：`654ba86`；共享文档对账提交 `657a6f3`。页面协议现为 **6.0**，
  ...
  评论、ADR-0068 与 `docs/archive/wayfinder-95/2026-09-07-url-navigation-109.md`，不得冻结旧 pageId API。
