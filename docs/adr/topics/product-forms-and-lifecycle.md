...
页面创作流程的生产硬切换与版本边界见 [ADR-0090](../0090-authoring-flow-hard-cutover-and-version-vocabulary.md)：平台创作可由内容工具提交草稿，草稿保存、Relay 会话检查点和正式页面发布分别归不同边界；结构计划版本不能与页面 Schema、Bundle 或外部 API 版本混用。
