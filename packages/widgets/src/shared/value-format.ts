...
/**
 * 数据值 → 有限数字。空值、布尔、空串、非数值字符串与 NaN/Infinity 一律视为缺失。
 * 展示格式化、表格 rateBar 与图表的数据缺口(折线断开、柱条不画)共用这一份判定。
 */
export function finiteNumber(value: FieldValue | undefined): number | undefined {
