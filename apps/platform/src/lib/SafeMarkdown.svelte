<script lang="ts">
  import { parseSafeMarkdown, type MarkdownInline } from './safe-markdown';
...
<style>
  ...
  .h1 { font-size: 1.15em; }.h2 { font-size: 1.08em; }.h3 { font-size: 1.02em; }
  ol, ul { display: grid; gap: 3px; padding-left: 16px; }
  blockquote { padding-left: 8px; border-left: 2px solid #aaa5e7; }
  pre { overflow-x: auto; padding: 7px; background: rgb(255 255 255 / .62); border-radius: 5px; }
  code { padding: 1px 3px; background: rgb(255 255 255 / .68); border-radius: 3px; font: 0.92em/1.4 ui-monospace, SFMono-Regular, Menlo, monospace; }
