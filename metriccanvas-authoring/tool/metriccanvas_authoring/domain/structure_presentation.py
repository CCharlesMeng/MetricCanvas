...
def capabilities():
    ...
    from metriccanvas_authoring.domain.page_structure import PLAN_SCHEMA, V3_PLAN_SCHEMA
...
def apply_presentation(block, source, component):
    from metriccanvas_authoring.domain.page_structure import field_id, StructureError
