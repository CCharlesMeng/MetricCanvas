...
from metriccanvas_authoring.domain.page_building import (
    ExecutableUnit, UnitScope, PageBuildingIssue, _component_for, ASSEMBLED_COMPONENT_TYPES,
)
...
def block_component(block, sources, pattern='custom', *, relations=()):
    ...
    from metriccanvas_authoring.domain.structure_presentation import purpose_intent
    ...
    if block.get('presentation', {}).get('kind') == 'metric-summary':
        from metriccanvas_authoring.domain.section_presentation import present_metric_summary
    ...
    from metriccanvas_authoring.domain.structure_presentation import apply_presentation
