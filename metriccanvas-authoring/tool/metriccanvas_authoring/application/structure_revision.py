...
from metriccanvas_authoring.domain.structure_preflight import inspect_plan
        ...
        for s in result['document']['sections'][1:]:
            ...
            for c in s['components']:
                ...
                if replaced and plan['version']=='3' and previous['type']==c['type']:
                    from metriccanvas_authoring.domain.page_structure import block_component
                    from metriccanvas_authoring.domain.structure_presentation import preserve_unedited
                    original=entries[-1]
