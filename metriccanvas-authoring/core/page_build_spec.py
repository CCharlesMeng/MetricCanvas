...
def validate_page_build_spec(value: Any) -> list[PageBuildSpecIssue]:
    ...
    schema = _read_json("page-build-spec.schema.json")
    ...
    intents = set(_read_json("analysis-intents.json")["intents"])
    component_types = {entry["type"] for entry in _read_json("component-catalog.json")}
