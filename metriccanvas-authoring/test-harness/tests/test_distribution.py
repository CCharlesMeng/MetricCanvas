...
class DistributionContractTest(unittest.TestCase):
    ...
    def test_sdist_embeds_all_runtime_contracts_for_wheel_build(self) -> None:
        ...
        expected = {
            ...
            "metriccanvas_authoring/_bundle/contracts/authored/lifecycle-request.schema.json",
            "metriccanvas_authoring/_bundle/contracts/authored/publish-request.schema.json",
            "metriccanvas_authoring/_bundle/contract-snapshot/authoring/publication.schema.json",
            "metriccanvas_authoring/_bundle/contract-snapshot/page/map-regions.json",
